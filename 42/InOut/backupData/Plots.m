...
fileID = fopen('STval.42','r');
formatSpec = '%f';
sizeA = [1 Inf];
stval = fscanf(fileID, formatSpec, sizeA);

fileID = fopen('StarTracker.42','r');
formatSpec = '%f';
sizeA = [4 Inf];
stqbn = fscanf(fileID, formatSpec, sizeA);

fileID = fopen('BoS.42','r');
formatSpec = '%f';
sizeA = [1 Inf];
BoS = fscanf(fileID, formatSpec, sizeA);
...
figure
subplot(4,1,1);
plot(time,cmd(1,:), time,qbn(1,:), time,acqbn(1,:), time,stqbn(1,:), time, stval(:), time, BoS(:));
title('Quaternion command');
xlabel('time[sec]');
ylabel('M');
subplot(4,1,2);
plot(time,cmd(2,:), time,qbn(2,:), time,acqbn(2,:), time,stqbn(2,:), time, stval(:), time, BoS(:));
xlabel('time[sec]');
ylabel('M');
subplot(4,1,3);
plot(time,cmd(3,:), time,qbn(3,:), time,acqbn(3,:), time,stqbn(3,:), time, stval(:), time, BoS(:));
xlabel('time[sec]');
ylabel('M');
subplot(4,1,4);
plot(time,cmd(4,:), time,qbn(4,:), time,acqbn(4,:), time,stqbn(4,:), time, stval(:), time, BoS(:));
xlabel('time[sec]');
ylabel('M');
